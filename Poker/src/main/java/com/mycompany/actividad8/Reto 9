...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        Deck arg1 = Deck.valueOf(args[0]);
        Barajar arg2 = Barajar.valueOf(args[1]);
        Random arg3 = Random.valueOf(args[2]);

        System.out.println(arg1 + " Deck: " + arg1.getClass().getName());
        System.out.println(arg2 + " Barajar: " + arg2.getClass().getName());
        System.out.println(arg3 + " Random: " + arg3.getClass().getName());
        
        deck.getCard().get(0).getPalo()
        deck.getCard().get(0) 
        Card card =deck.getCard().get(0)
        card.getPalo();
...
public class Deck {
    ...
    public static void main(String[] args) {
        ...
        String formatString = "Opinon no válida";

        String result = String.format(formatString, name, PI, percentage);
